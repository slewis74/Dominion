...
namespace Dominion.Tests.RequestBrokerScenarios.MulticastRequest
{
    [TestClass]
    public class RequestBrokerWithChildScopePerPublishScenarios
    {
        ...
        public async Task FirstResponseIsReturned()
        {
            ...
            response.First().Id.ShouldBe("SyncHandler");
        }

        [TestMethod]
        public async Task SecondResponseIsReturned()
        {
            _lastLifetimeScopeTag = null;
            _subject.Subscribe(typeof(TestRequest), typeof(TestSyncHandler));
            _subject.Subscribe(typeof(TestRequest), typeof(TestAsyncHandler));
            ...
            response.Last().Id.ShouldBe("AsyncHandler");
        }
        ...
        public async Task SyncLifetimeScopeIsntOfTheContainer()
        {
            ...
            response.First().LifetimeScopeWasContainer.ShouldBe(false);
        }
        ...
        [TestMethod]
        public async Task AsyncLifetimeScopeIsSameAsSync()
        {
            _lastLifetimeScopeTag = null;
            _subject.Subscribe(typeof(TestRequest), typeof(TestSyncHandler));
            _subject.Subscribe(typeof(TestRequest), typeof(TestAsyncHandler));
            ...
            response.Last().LifetimeScopeTagWasSameAsPrevious.ShouldBe(true);
        }
        ...
        public class TestSyncHandler : IHandleRequest<TestRequest, TestResponse>
        {
            ...
            public TestSyncHandler(ILifetimeScope lifetimeScope)
            {
                ...
                _lifetimeScopeTagWasSameAsPrevious = lifetimeScope.Tag == _lastLifetimeScopeTag;
